...
import org.camunda.bpm.engine.org.camunda.bpm.engine.impl.bpmn.delegate.ExpressionDelegateInvocation;
...
public class UelExpressionCondition implements Condition {
    ...
    public boolean evaluate(VariableScope scope, DelegateExecution execution) {
        ...
        //NEW SECTION:
        if (result instanceof ExpressionDelegate){
            ExpressionDelegateInvocation invocation = new ExpressionDelegateInvocation((ExpressionDelegate) result, execution);

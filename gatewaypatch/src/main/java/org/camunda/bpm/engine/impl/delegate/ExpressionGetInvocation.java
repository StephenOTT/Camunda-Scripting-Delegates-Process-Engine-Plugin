...
public class ExpressionGetInvocation extends DelegateInvocation {
    ...
    protected void invoke() throws Exception {
        ...
        if (value instanceof ExpressionDelegate){
            invocationResult =((ExpressionDelegate)valueExpression.getValue(elContext)).evaluate((VariableScope) elContext.getContext(VariableScope.class));
        } else {
